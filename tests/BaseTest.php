...
class BaseTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testReadFile()
    {
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Definitions', $definitions);
    ...
    protected function makeAssertionsLoad(Definitions $definitions)
    {
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Message', $messages['GetQuoteSoapIn']);
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Message', $messages['GetQuoteSoapOut']);
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Message\Part', $messageParts['parameters']);
        $this->assertInstanceOf('Goetas\XML\XSDReader\Schema\Element\ElementDef', $messageParts['parameters']->getElement());
        ...
        $this->assertArrayHasKey('parameters', $messageParts);
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Message\Part', $messageParts['parameters']);
        $this->assertInstanceOf('Goetas\XML\XSDReader\Schema\Type\ComplexType', $messageParts['parameters']->getType());
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\PortType', $portTypes['StockQuoteSoap']);
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\PortType\Operation', $operations['GetQuote']);
        $this->assertSame($portType->getOperation('GetQuote'), $operations['GetQuote']);

        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\PortType\Param', $operations['GetQuote']->getInput());
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\PortType\Param', $operations['GetQuote']->getOutput());
        $this->assertEmpty($operations['GetQuote']->getFaults());

        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\PortType\Operation', $operations['GetQuoteWithFault']);
        $this->assertSame($portType->getOperation('GetQuoteWithFault'), $operations['GetQuoteWithFault']);

        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\PortType\Param', $operations['GetQuoteWithFault']->getInput());
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\PortType\Param', $operations['GetQuoteWithFault']->getOutput());
        $this->assertCount(1, $operations['GetQuoteWithFault']->getFaults());
        $this->assertContainsOnlyInstancesOf('Goetas\XML\WSDLReader\Wsdl\PortType\Fault', $operations['GetQuoteWithFault']->getFaults());
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Binding', $bindings['StockQuoteSoap']);
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Binding\Operation', $operations['GetQuote']);
        $this->assertSame($binding->getOperation('GetQuote'), $operations['GetQuote']);

        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Binding\OperationMessage', $operations['GetQuote']->getInput());
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Binding\OperationMessage', $operations['GetQuote']->getOutput());
        $this->assertEmpty($operations['GetQuote']->getFaults());


        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Binding\Operation', $operations['GetQuoteWithFault']);
        $this->assertSame($binding->getOperation('GetQuoteWithFault'), $operations['GetQuoteWithFault']);

        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Binding\OperationMessage', $operations['GetQuoteWithFault']->getInput());
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Binding\OperationMessage', $operations['GetQuoteWithFault']->getOutput());
        $this->assertCount(2, $operations['GetQuoteWithFault']->getFaults());
        $this->assertContainsOnlyInstancesOf('Goetas\XML\WSDLReader\Wsdl\Binding\OperationFault', $operations['GetQuoteWithFault']->getFaults());
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Service', $services['StockQuote']);
        ...
        $this->assertInstanceOf('Goetas\XML\WSDLReader\Wsdl\Service\Port', $ports['StockQuoteSoap']);
